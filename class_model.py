    ...
    def forward(ctx, z0, t, flat_parameters, func):
        ...
        with torch.no_grad():
            ...
            for i_t in range(time_len - 1):
                samp_ts = torch.zeros(2)
                z0 = ode_solve(z0, t[i_t], t[i_t+1], func)
                samp_ts[0] = t[i_t, 1]
                samp_ts[1] = t[i_t+1, 1]
                z_dp = tde.odeint(func, y0=z0, t=samp_ts)
                print(z0.shape, z_dp.shape, z_dp.permute(1, 0, 2).shape, samp_ts.shape)
                z[i_t+1] = z0
        ctx.func = func
